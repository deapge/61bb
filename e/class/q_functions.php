...
function AddFeedback($add){
	...
	if(empty($bid))
	{
		...
		exit('<script type="text/javascript">document.domain="'.$public_r[add_domain].'";parent.Module.FeedBack.ShowResult(1);</script>');
    }
	...
	if(empty($br['bid']))
	{
		...
		exit('<script type="text/javascript">document.domain="'.$public_r[add_domain].'";parent.Module.FeedBack.ShowResult(2);</script>');
	}
	//权限
	if($br['groupid'])
	{
	...
	if($sql)
	{
		...
		exit('<script type="text/javascript">document.domain="'.$public_r[add_domain].'";parent.Module.FeedBack.ShowResult(0);</script>');
	}
	else
	{printerror("DbError","history.go(-1)",1);}
}
