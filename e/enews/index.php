...
//导入文件
if($enews=='AddPl'||$enews=='DoForPl'||$enews=='DoForPl_4usky')
{
	include('plfun.php');
}
...
if($enews=="AddPl")//增加评论
{
	...
	$key=$_POST['key'];
	//4usky.com 9-2-g-ame.net
	//AddPl_flash34($username,$password,$nomember,$key,$saytext,$id,$classid,$repid,$_POST);
...
elseif($enews=='DoForPl_4usky')//评论意见 --------------------4usky.com
{
	DoForPl_4usky($_GET);
}
