...
function AddInfoPfen($add){
	...
	//echo("update {$dbtbpre}ecms_".$class_r[$classid]['tbname']." set infopfen=infopfen+$fen,infopfennum=infopfennum+1 where id=$id and classid=$classid");
	...
	if($sql)
	{
		...
		//{
			...
			//echo('var gScoreReportResult = {"result":0,"resultstr":"操作成功！","uin":0};');
		//}
	}
	else
	{
