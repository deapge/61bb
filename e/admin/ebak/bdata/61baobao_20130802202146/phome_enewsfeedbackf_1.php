...
E_D("replace into `phome_enewsfeedbackf` values('2','message','内容','textarea','','8','TEXT','','','');");
...
E_D("replace into `phome_enewsfeedbackf` values('10','url','反馈页面','text','','9','VARCHAR','255','','');");
E_D("replace into `phome_enewsfeedbackf` values('11','gameid','游戏ID','text','','10','VARCHAR','255','','');");
E_D("replace into `phome_enewsfeedbackf` values('12','causes','满意不满意理由','text','','11','VARCHAR','255','','');");
