...
<input type=radio name=lifetime value=315360000>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="25">&nbsp;</td>
      <td height="25"><input type="submit" name="Submit" value=" 登 陆 ">&nbsp;&nbsp;&nbsp; <input type="button" name="button" value="马上注册" onclick="parent.location.href='../register/';"><a target="_self" href="javascript:void(0);" onclick="qzonelogin();" class="bt_login"><img border="0" src="/img/portal/v2/common/qq_login.png"></a></td>
    </tr>
	</form>
  </table>
...
{
	echo"<meta http-equiv=\"refresh\" content=\"1;url=/e/member/cp/index.php\">";
}
