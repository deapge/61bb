...
?>
	<table width="500" height="200" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
	<tr class="header"> 
      <td height="25"><div align="center">会员登陆</div></td>
    </tr>
	 <tr> 
      <td><div align="center"><a target="_self" href="javascript:void(0);" onclick="qzonelogin();" class="bt_login"><img border="0" src="/img/portal/v2/common/qq_login.png"></a>
		</div></td>
    </tr>
  </table>
...
{
	echo"<meta http-equiv=\"refresh\" content=\"1;url=/e/member/cp/\">";
}
